...
ARG BASE_IMAGE
ARG BASE_R_LIBS
ENV BASE_R_LIBS="${BASE_R_LIBS:-caTools dplyr devtools formatR remotes rmarkdown selectr shiny tidyverse}"
...
ONBUILD RUN R_LIBS_INSTALLED="${BASE_R_LIBS}" "${SCRIPT_DIR}/install-r-libs.sh" "${SHINY_APPS_DIR}"
